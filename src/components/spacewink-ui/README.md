...
![image](http://spacewinkgis.cn/dev/img/guide/project-vue-hebing.jpg)
...
基础项目已经基本保证不会影响外部样式，此处要处理的是您项目中的全局样式对 spacewinkgis 相关组件的影响。修改相关 CSS 保证基础项目功能 UI 正常即可。
